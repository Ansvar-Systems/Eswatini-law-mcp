/**
 * Eswatini Law PDF Parser
 *
 * Parses text extracted from Eswatini proclamation PDFs (Federal Negarit Gazette).
...
export function parseEswatiniLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parsePdfText(html, act);
}
