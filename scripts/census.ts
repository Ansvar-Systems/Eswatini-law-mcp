#!/usr/bin/env tsx
/**
 * Eswatini Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from laweswatini.com.
...
const BASE_URL = 'https://www.laweswatini.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-eswatini',
  ...
  'parliament', 'police', 'president-of-eswatini', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('laweswatini.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Eswatini Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Eswatini (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
