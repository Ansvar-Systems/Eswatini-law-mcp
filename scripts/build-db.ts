#!/usr/bin/env tsx
/**
 * Database builder for Eswatini Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Eswatini Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Eswatini statute text',
              );
  ...
  const writeMeta = db.transaction(() => {
    ...
    insertMeta.run('source', 'laweswatini.com');
