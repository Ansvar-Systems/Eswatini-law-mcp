...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Eswatini Legal Information Portal',
          authority: 'laweswatini.com (Eswatini Legal Information Portal)',
          url: 'https://www.laweswatini.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Eswatini (1995), major legislative acts from 1995 to present, ' +
